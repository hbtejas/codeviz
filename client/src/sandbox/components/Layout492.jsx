    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Controls</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Command the glass from a floating bar
          </h1>
          <p className="md:text-md">
            The playback controls hover over the canvas like a pilot's
            instrument panel. It frees the vertical space for what matters, the
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Drag the progress handle and a thumbnail pops up showing the
                  exact line number. You see where you are before you commit to
                  the jump.
                </p>
              </motion.div>
            </div>
