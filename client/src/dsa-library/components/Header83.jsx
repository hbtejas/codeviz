          ...
          <div className="px-[5%] py-16 md:py-24 lg:py-28">
            <div className="relative z-10 mx-auto max-w-lg text-center">
              <h1 className="mb-5 text-6xl font-bold text-text-alternative md:mb-6 md:text-9xl lg:text-10xl">
                See the algorithm. Know the truth.
              </h1>
              <p className="text-text-alternative md:text-md">
                A clean, searchable gallery of data structures and algorithms.
                Each one opens into a live visualizer so you can watch the logic
                move.
              </p>
              <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
                <Button title="Explore">Explore</Button>
                <Button title="Sandbox" variant="secondary-alt">
                  Sandbox
                </Button>
              </div>
            </div>
